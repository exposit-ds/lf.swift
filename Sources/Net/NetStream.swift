...
open class NetStream: NSObject {
...
#if os(iOS) || os(macOS)
    open func attachCamera(_ camera:LFCaptureDevice?, onError:((_ error:NSError) -> Void)? = nil) {
        lockQueue.async {
            do {
    ...
    open func attachAudio(_ audio:LFCaptureDevice?, automaticallyConfiguresApplicationAudioSession:Bool = false, onError:((_ error:NSError) -> Void)? = nil) {
        lockQueue.async {
            do {
